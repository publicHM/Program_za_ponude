/**
 * Helper class with method that returns translated text based on passed cutomer language
 * 
 * @author Petar
 */
package saveAsXLS;
    ...
    private void setText(String language){
        switch(language){
            ...
            case "Engleski UK":
                ...
                jawImagePath = "\\src\\images\\JawImageEnglish.jpeg";
                break;
            case "Hrvatski":
                ...
                jawImagePath = "\\src\\images\\JawImageCroatian.jpeg";
                break;
            case "Njemački":
                ...
                jawImagePath = "\\src\\images\\JawImageGerman.jpeg";
                break;
            case "Talijanski":
                ...
                jawImagePath = "\\src\\images\\JawImageItalian.jpeg";
                break;
        }
    }
